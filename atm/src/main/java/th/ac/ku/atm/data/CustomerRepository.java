...
public class CustomerRepository {
    ...
    public List<Customer> findAll() {
        ...
        List<Customer> customers =
                jdbcTemplate.query(query, new CustomerRoeMapper());
        return customers;
    }
    ...
    public Customer findById(int id) {
        ...
        Customer customer =
                jdbcTemplate.queryForObject(query, new CustomerRoeMapper());
        return customer;
    }
    ...
    class CustomerRoeMapper implements RowMapper<Customer> {
